...
export function renderMainMenu({ onBegin, onNavigate }) {
  ...
  container.className =
    "flex flex-col items-center justify-center h-full space-y-12 z-10 relative opacity-0 transform translate-y-[-20px] transition-all duration-1000";
  ...
  setTimeout(() => {
    ...
    container
      .querySelector("#btn-achievements")
